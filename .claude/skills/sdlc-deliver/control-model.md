...
- **Autonomy level (1–5)** — how independently the agent may proceed. See
  `.claude/skills/sdlc-knowledge/reference/autonomy/levels.md`. Default `2`.
...
These **pause the loop regardless of score or autonomy level** (from
`.claude/skills/sdlc-knowledge/reference/autonomy/escalation-policy.md`):
