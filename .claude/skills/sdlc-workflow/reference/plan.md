...
- **Format:** Run-directory artifacts under `.sdlc/runs/<slug>/`: `contract.md`, `state.md`, `01-requirements-brief.md`, `02-design-note.md`, `03-risk-register.md`, `resolutions.md`. Each artifact follows the template under `.claude/skills/sdlc-knowledge/reference/templates/` and ends with a fenced `### sdlc-result` block.
...
| `.claude/skills/sdlc-knowledge/reference/templates/minimal-input-contract.md` | Shape of the contract built in gate 0 |
| `.claude/skills/sdlc-knowledge/reference/agent/change-classes.md` | Change taxonomy used by gate 0 to pick the gate profile |
| `.claude/skills/sdlc-knowledge/reference/context-packs/01..09` | Per-repo knowledge — gates 1–3 each select the packs they need |
| `.claude/skills/sdlc-knowledge/reference/quality-gates/{1,2,3}-*.md` | Canonical gate specs and checklists |
| `.claude/skills/sdlc-knowledge/reference/autonomy/{levels,escalation-policy}.md` | Autonomy level and hard-stop trigger list |
